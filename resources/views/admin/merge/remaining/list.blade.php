 ...
 ?>
                                                    ...
                                                    @endif
                                                        ...
                                                        <td>
                                                            ...
                                                            <a class="btn btn-xs btn-primary" href="{{route('admin.unmergeremaining',['id'=>$merge->id])}}">Unmerge</a>

                                                            <hr>

                                                         
                                                            <a class="btn btn-xs btn-primary" href="{{route('admin.merge.confirmremaining',['id'=>$merge->id])}}">Confirm</a>
