                    ...
                    <div class="col-lg-12 col-md-12 col-xl-12">
                        <div class="card-box">
                            <h5 class="portlet-title text-dark text-uppercase">
                               FILTER BY: 
                               <a class="btn btn-xs btn-primary" href="{{route('admin.user.dpr.list',['filterBy'=>'eth'])}}">ETH</a>
                               <a class="btn btn-xs btn-primary" href="{{route('admin.user.dpr.list',['filterBy'=>'lc'])}}">LC</a>
                               <a  class="btn btn-xs btn-primary" href="{{route('admin.user.dpr.list',['filterBy'=>'etn'])}}">ETN</a>
                            </h5>


                            <legend style="text-transform: uppercase;">
                                
                                {{$filterBy}} Downpayment receivers
                            </legend> 
