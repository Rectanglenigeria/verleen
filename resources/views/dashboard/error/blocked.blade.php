                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-xlg-3 col-md-5">
                        <div class="card">
                            ...
                            <span>
                                <hr> </span>
                            <div class="card-body"> <small class="text-muted">Blockage Status</small>
                    ...
                    <div class="col-lg-6 col-xlg-9 col-md-7 col-sm-5, col-xs-5">
                        <div class="card">
                            ...
                            <ul class="nav nav-tabs profile-tab" role="tablist">
                                <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#settings" role="tab">Blockage status</a> </li>
                            </ul>
                            <!-- Tab panes -->
                            <div class="tab-content">
                                <!--second tab-->
                                 <div class="alert alert-success" role="alert">
                            You've been blocked from the system. Contact the admin.
                         </div>
