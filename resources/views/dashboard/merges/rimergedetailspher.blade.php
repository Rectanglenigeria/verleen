                                ...
                                <div class="tab-pane active" id="settings" role="tabpanel">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <a href="{{route('user.merge.remaining.flag', ['id'=>$detail->id])}}" class="btn btn-sm btn-danger">Fake</a>

                                             <a href="{{route('user.merge.remaining.extendtime', ['id'=>$detail->id])}}" class="btn btn-sm btn-primary">Extend time</a>



                                              <a href="{{route('user.merge.remaining.confirm', ['id'=>$detail->id])}}" class="btn btn-sm btn-primary">Confirm</a>
