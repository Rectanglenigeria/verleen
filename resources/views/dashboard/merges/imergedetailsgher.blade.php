                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="settings" role="tabpanel">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <form class="form-horizontal form-material" action="{{route('user.merge.insurance.teller.submit')}}" method="POST" enctype="multipart/form-data"h>
                                ...
                                @endif
                                            ...
                                            @else
                                             ...
                                             <form class="form-horizontal form-material" action="{{route('user.merge.insurance.hash.submit')}}" method="POST">
                                ...
                                @endif
                                      ...
                                      <hr>
                                            ...
                                            <legend>
                                              ...
                                              <a href="{{route('user.merge.insurance.default', ['id'=>$detail->id])}}" class="btn btn-sm btn-primary">I can't pay</a>
